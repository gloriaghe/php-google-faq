...
$arr_domande = [
    ...
    [
        ...
        "risp" => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.
    ...
    [
        ...
        "risp" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
...
<body>
    ...
    <section><?php
        foreach ($arr_domande as $domanda) {
            echo "<h2>{$domanda['dom']}</h2> <span>{$domanda['risp']}</span>";
        }
    ?></section>
    </body>
</html>
